...
class HParams():
    ...
    def __init__(self,base_dir):
        ...
        self.conformer_depthwise_conv_kernel=33 
        ...
        self.standard_train_type=['train-clean-360','train-other-500'] 
        ...
        self.standard_linear_nodes=512 
        self.standard_decoder_layers=1 
        self.standard_decoder_bidirectional=True 
        self.standard_decoder_nodes=512 
